...
@pytest.mark.parametrize(
    ...
    [
        (
            # usual
            "odds3f.rno=1&jcd=14&hd=20201024.html",
            "expected_odds3f.rno=1&jcd=14&hd=20201024.json",
        ),
        (
            # racer missing
            "odds3f.rno=2&jcd=10&hd=20201129.html",
            "expected_odds3f.rno=2&jcd=10&hd=20201129.json",
        ),
        (
            # cancelled race
            "odds3f.rno=8&jcd=08&hd=20190126.html",
            "expected_odds3f.rno=8&jcd=08&hd=20190126.json",
        ),
    ]
)
